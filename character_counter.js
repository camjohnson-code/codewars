...
// that word has the exact same number of occurrences. You will return true if it is valid, or false if it is not.
...
const validateWord = (s) => {
  ...
  const counts = new Set(Object.values(letterCount));
