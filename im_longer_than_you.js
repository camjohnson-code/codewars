// Create a function longer that accepts a string and sorts the words in it based on their respective
// lengths in an ascending order. If there are two words of the same lengths, sort them alphabetically.
